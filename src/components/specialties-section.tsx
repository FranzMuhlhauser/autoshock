    ...
    <div className="group flex flex-col p-4 border border-border/50 rounded-lg bg-background/50 hover:border-primary/50 transition-all text-center">
      ...
      {imgSrc && (
        <div className="mt-4 h-24 flex items-end justify-center overflow-hidden">
          <Image
            src={imgSrc}
            alt={`Imagen de ${title} para tren delantero`}
            width={120}
            height={90}
                        ...
                        <AccordionContent className="pt-4">
                            ...
                            <div className="w-full mx-auto mb-4">
                                <div className="flex justify-center gap-4 items-center">
                                    <div className="w-1/4 overflow-hidden rounded-lg">
                                        <Image src="/images/productos/amortiguadores_gabriel.webp" alt="Amortiguadores para autos marca Gabriel" width={480} height={320} className="w-full h-auto object-cover rounded-lg transition-all duration-300 hover:scale-110 hover:brightness-110 -rotate-6 hover:[filter:drop-shadow(0_0_10px_rgba(255,215,0,0.4))]" />
                                    </div>
                                    <div className="w-1/4 overflow-hidden rounded-lg">
                                        <Image src="/images/productos/amortiguador_kyb.webp" alt="Amortiguador de alto rendimiento marca KYB" width={480} height={320} className="w-full h-auto object-cover rounded-lg transition-all duration-300 hover:scale-110 hover:brightness-110 rotate-6 hover:[filter:drop-shadow(0_0_10px_rgba(255,215,0,0.4))]" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-2 text-center">
                                ...
                                <div className="flex justify-center items-center gap-4">
                                    <Image src="/images/Logos/Bilstein-logo.webp" alt="Logo marca Bilstein" width={140} height={40} className="object-contain transition-transform duration-300 hover:scale-110" />
                                    <Image src="/images/Logos/corven-logo.webp" alt="Logo marca Corven" width={140} height={40} className="object-contain transition-transform duration-300 hover:scale-110" />
                                    <Image src="/images/Logos/Gabriel_logo.webp" alt="Logo marca Gabriel" width={140} height={40} className="object-contain transition-transform duration-300 hover:scale-110" />
                                    <Image src="/images/Logos/ibn-logo.webp" alt="Logo marca IBN" width={140} height={40} className="object-contain transition-transform duration-300 hover:scale-110" />
                                </div>
                                ...
                                <div className="w-1/2 mx-auto mb-4">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                                        <div className="overflow-hidden rounded-lg">
                                            <Image src="/images/productos/amortiguador_daher.webp" alt="Amortiguador de portalón marca Daher" width={300} height={200} className="w-full h-full object-cover rounded-lg transition-all duration-300 hover:scale-105 hover:[filter:drop-shadow(0_0_10px_rgba(255,215,0,0.2))]" />
                                        </div>
                                        <div className="overflow-hidden rounded-lg">
                                            <Image src="/images/productos/pack_amortiguador_daher.webp" alt="Pack de amortiguadores de maletero Daher" width={300} height={200} className="w-full h-full object-cover rounded-lg transition-all duration-300 hover:scale-105 hover:[filter:drop-shadow(0_0_10px_rgba(255,215,0,0.2))]" />
                                        </div>
                                    </div>
                                </div>
                                <h4 className="font-semibold text-center text-xl mt-6 mb-4 text-premium-yellow">Marca Especializada</h4>
                                <div className="mt-4 flex justify-center">
                                     <Image src="/images/Logos/logo_daher.webp" alt="Logo marca Daher" width={180} height={50} className="object-contain transition-transform duration-300 hover:scale-110" />
                                </div>
                            </div>
                        </AccordionContent>
                    </AccordionItem>
                        ...
                        <AccordionContent className="pt-4">
                           <div className="grid md:grid-cols-2 gap-8 items-center">
                                ...
                                <div className="overflow-hidden rounded-lg w-full flex justify-center items-center">
                                    <Image src="/images/productos/catalitico_gabriel.webp" alt="Convertidor catalítico para auto marca Gabriel" width={320} height={320} className="w-64 h-auto object-cover rounded-lg transition-all duration-300 hover:scale-110 hover:[filter:drop-shadow(0_0_10px_rgba(255,215,0,0.2))]" />
                                </div>
                            </div>
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-4" className="bg-background border-primary/20">
                        ...
                        <AccordionContent className="pt-4">
                            <div className="grid md:grid-cols-2 gap-8 items-center">
                                ...
                                <div className="overflow-hidden rounded-lg w-full flex justify-center items-center">
                                    <Image src="/images/productos/amortiguador_camion.webp" alt="Amortiguador de alta resistencia para camiones" width={160} height={160} className="w-40 h-auto object-cover rounded-lg transition-all duration-300 hover:scale-110 hover:[filter:drop-shadow(0_0_10px_rgba(255,215,0,0.2))]" />
                                </div>
                            </div>
                           <h4 className="font-semibold text-center text-xl mt-6 mb-4 text-premium-yellow">Marcas Especializadas</h4>
                            <div className="mt-4 flex justify-center items-center gap-4 flex-wrap">
                                <Image src="/images/Logos/eurotec_logo.webp" alt="Logo marca Eurotec" width={140} height={40} className="object-contain transition-transform duration-300 hover:scale-110" />
                                <Image src="/images/Logos/Gabriel_logo.webp" alt="Logo marca Gabriel" width={140} height={40} className="object-contain transition-transform duration-300 hover:scale-110" />
                                <Image src="/images/Logos/sachs_logo.webp" alt="Logo marca Sachs" width={140} height={40} className="object-contain transition-transform duration-300 hover:scale-110" />
                                <Image src="/images/Logos/monroe_logo.webp" alt="Logo marca Monroe" width={140} height={40} className="object-contain transition-transform duration-300 hover:scale-110" />
                                <Image src="/images/Logos/prt_logo_resultado.webp" alt="Logo marca PRT" width={140} height={40} className="object-contain transition-transform duration-300 hover:scale-110" />
                            </div>
                        </AccordionContent>
                    </AccordionItem>
                        ...
                        <AccordionContent className="pt-4">
                            ...
                            <div className="mt-6 text-center">
                                <div className="flex justify-center items-center gap-x-8 gap-y-4 flex-wrap">
                                    <Image src="/images/Logos/moog_logo.webp" alt="Logo marca MOOG" width={120} height={35} className="object-contain transition-transform duration-300 hover:scale-110" />
                                    <Image src="/images/Logos/thc_logo.webp" alt="Logo marca THC" width={120} height={35} className="object-contain transition-transform duration-300 hover:scale-110" />
                                    <Image src="/images/Logos/corven-logo.webp" alt="Logo marca Corven para tren delantero" width={120} height={35} className="object-contain transition-transform duration-300 hover:scale-110" />
                                    <Image src="/images/Logos/osung_logo.webp" alt="Logo marca Osung" width={120} height={35} className="object-contain transition-transform duration-300 hover:scale-110" />
                                </div>
