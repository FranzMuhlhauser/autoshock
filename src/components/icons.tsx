...
export const WazeLogo = (props: SVGProps<SVGSVGElement>) => (
    <svg 
        ...
        {...props}
    >
        <path d="M12 2c-4.42 0-8 3.58-8 8 0 1.95.7 3.73 1.86 5.14L4 22l6.8-2.04a7.98 7.98 0 0 0 1.2.04h.02c4.42 0 8-3.58 8-8s-3.58-8-8-8zm4.29 10.71c-.28.28-.65.44-1.06.44s-.78-.16-1.06-.44c-.59-.59-.59-1.54 0-2.12.59-.59 1.54-.59 2.12 0 .59.59.59 1.54 0 2.12zm-8.58 0c-.28.28-.65.44-1.06.44s-.78-.16-1.06-.44c-.59-.59-.59-1.54 0-2.12.59-.59 1.54-.59 2.12 0 .59.59.59 1.54 0 2.12zm5.39-3.21a.75.75 0 0 1-.75-.75c0-.62-.51-1.12-1.13-1.12s-1.13.5-1.13 1.12a.75.75 0 0 1-1.5 0C8.63 7.57 9.7 6.5 11.25 6.5S13.88 7.57 13.88 9c0 .41.34.75.75.75s.75-.34.75-.75c0-2.49-2.02-4.5-4.5-4.5S6.38 6.51 6.38 9c0 .41.34.75.75.75s.75-.34.75-.75c0-.62.51-1.12 1.13-1.12s1.13.5 1.13 1.12a.75. ৭৫ 0 0 1 .75.75c0 2.49 2.02 4.5 4.5 4.5s4.5-2.01 4.5-4.5a.75.75 0 0 1-.75.75z" />
    </svg>
);
