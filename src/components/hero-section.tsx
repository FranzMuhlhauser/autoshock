  ...
  return (
    <section id="inicio" className="relative w-full min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 container text-center px-4">
        <Badge variant="secondary" className="mb-4 py-1 px-3 bg-primary/10 border-primary/50 text-primary text-sm md:text-base">Más de 25 años de experiencia</Badge>
        ...
        <p className="max-w-xl mx-auto text-muted-foreground mb-8">
          Especialistas en venta de repuestos automotrices de alta calidad, desde amortiguadores y trenes delanteros hasta portalones y catalíticos.
        </p>
